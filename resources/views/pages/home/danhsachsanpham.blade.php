...
@section('web_content')
    ...
    <link rel="stylesheet" href="{{ asset('public/fontend/assets/css/danhmuc.css') }}">
    <!-- {{-- jquery --}} -->
        ...
        <div class="row show-all-product">
            <div class="col-md-3 category-menu leftSidebar">
                <div class="hello theiaStickySidebar">
                    <span>The Seafood</span>
                    <div class="box-search">
                        <!-- <span>Tìm kiếm sản phẩm</span> -->
                        <div class="box-search-item">
                            <input id="input" class="search-input" type="text" placeholder="Tìm kiếm"> <button
                                id="search-btn" class="btn-search"><i class="fa-solid fa-microphone"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="filter_content">
                        ...
                        <div class="option_filter_box">
                            <select name="" id="option-filter">
                                ...
                                <option value="DESC" data-type="product_price">Giá Giảm Dần</option>
                                <option value="ASC" data-type="product_price">Giá Tăng Dần</option>
                                <option value="ASC" data-type="product_name">Sắp xếp A-Z</option>
                                <option value="DESC" data-type="product_name">Sắp xếp Z-A</option>
                        ...
                        <div class="category-list">
                            ...
                            @foreach ($dataCategory as $category)
                                <div class="category-item">
                                    ...
                                    <label
                                        for="category-item-{{ $category->category_id }}">{{ $category->category_name }}</label>
                                </div>
                            @endforeach
                            {{-- <div class="category-item">
            ...
            <div class="col-md-9 all-product rightSidebar">
                ...
                <div class="row g-3 list-product loading-1 theiaStickySidebar">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <a href="/thongtinkhachsan.html" class="flashsalehotel_boxcontent_hover">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.13.2/jquery-ui.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="{{ asset('public/fontend/assets/js/ResizeSensor.js') }}"></script>
    <script src="{{ asset('public/fontend/assets/js/theia-sticky-sidebar.js') }}"></script>
    <script>
    ...
    <script>
        ...
        function getPosts() {
            ...
            $.ajax({
                url: '{{ url('/cua-hang/load-danh-sach-san-pham') }}',
                method: 'get',
                data: {

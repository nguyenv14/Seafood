        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ ('update-category') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control" id="" name="category_id" placeholder="ID_hidden" value="{{$editvalue->category_id}}">
                    <label for="exampleInputName1">Tên Thể Loại</label>
                    <input type="text" name="category_name" class="form-control" id="exampleInputName1" placeholder="Name" value="{{ $editvalue->category_name }}">
                </div>
                
                <div class="form-group">
                    <label for="exampleTextarea1">Mô Tả Thể Loại</label>
                    <textarea class="form-control" name="category_desc" id="exampleTextarea1" rows="4">{{ $editvalue->category_desc }}</textarea>
                </div>
